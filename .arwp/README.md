...
Audience: Engineers and release reviewers investigating a concrete enterprise change. Useful action: Inspect the synthetic impact report and why a target is included or excluded.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/enterprise-change-graph/
...
Compare materialized transformation graphs with a change-specific impact investigation; cite both maintained contracts.
